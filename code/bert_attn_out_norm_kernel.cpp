...
#pragma HLS INLINE off
    ...
    float bias_tile[OUT_TILE_O];
#pragma HLS ARRAY_PARTITION variable=bias_tile cyclic factor=8 dim=1
...
#pragma HLS ARRAY_PARTITION variable=wtile cyclic factor=8 dim=2
...
#pragma HLS ARRAY_RESHAPE variable=context_group cyclic factor=8 dim=2
#pragma HLS ARRAY_RESHAPE variable=residual cyclic factor=16 dim=2
#pragma HLS ARRAY_RESHAPE variable=projected cyclic factor=8 dim=2
