...
#pragma HLS ARRAY_PARTITION variable=context_bank0 cyclic factor=16 dim=1
#pragma HLS ARRAY_PARTITION variable=context_bank0 complete dim=2
#pragma HLS ARRAY_PARTITION variable=context_bank1 cyclic factor=16 dim=1
...
#pragma HLS ARRAY_RESHAPE variable=q cyclic factor=8 dim=2
#pragma HLS ARRAY_RESHAPE variable=k cyclic factor=8 dim=2
#pragma HLS ARRAY_RESHAPE variable=v cyclic factor=16 dim=2
#pragma HLS ARRAY_RESHAPE variable=group_context cyclic factor=16 dim=2
